  ...
  >
    <template v-slot:top>
      <v-toolbar
        flat
      >
        <v-toolbar-title>Tabela de funcionários</v-toolbar-title>
        <v-divider
          class="mx-4"
          inset
          vertical
      ...
      initialize () {
        this.desserts = [
          ...
          },
          {
            name: 'Ruan Matheus',
            id: 38,
            email: 'ruamat@gmail.com',
            cpf: '35467843765',
            setor:'Filmagem'
          },
          {
            name: 'Jorge Santos Silva',
            id: 47,
            email: 'silvasantos@gmail.com',
            cpf: '75849275837',
            setor:'CEO'
          },
          {
            name: 'Raquel Lucena Araújo',
            id: 72,
            email: 'araujoraquel@hotmail.com',
            cpf: '85838594867',
            setor:'CEO'
          },{
            name: 'Marlene Oliveira',
            id: 89,
            email: 'marlene564@gmail.com',
            cpf: '46785738579',
            setor:'Compras'
          },
          {
            name: 'Sarah Giovanna Sousa',
            id: 93,
            email: 'Sarahhh311@hotmail.com',
            cpf: '58385829108',
            setor:'Compras'
          },
          {
            name: 'Margarete Barreto',
            id: 39,
            email: 'margabarreto@gmail.com',
            cpf: '48385810094',
            setor:'RH'
          },
          {
